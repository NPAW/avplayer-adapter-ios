...
@interface YouboraConfigViewController : NSViewController <NSCollectionViewDataSource, NSCollectionViewDelegateFlowLayout>
...
- (void)insertIntoContainerWithContainerView:(NSView * _Nonnull)containerView;
