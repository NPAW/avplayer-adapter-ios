//
//  AvPlayerPolynetExampleViewModelObjc.m
...
#import "AvPlayerPolynetExampleViewModelObjc.h"
...
- (void)startYouboraWithPlayer:(AVPlayer *)player polynet:(PolyNet *)polynet andPolynetDelegate:(id<PolyNetDelegate>)polynetDelegate {
    [self.plugin fireInit];
    [self.plugin setAdapter:[[YBAVPlayerPolynetAdapter alloc] initWithPolyNet:polynet player:player]];
}
