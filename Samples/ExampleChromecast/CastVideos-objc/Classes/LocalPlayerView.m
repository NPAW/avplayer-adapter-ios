...
- (void)loadMediaPlayer {
  if (!_mediaPlayer) {
    ...
    YBOptions *opts = [YBOptions new];
    opts.accountCode = @"nicetest";
    self.plugin = [[YBPlugin alloc] initWithOptions:opts];
    [self.plugin setAdapter:[[YBAVPlayerAdapter alloc] initWithPlayer:_mediaPlayer]];
  }
}
